...
static unsigned int gappov    = 30;       /* vert outer gap between windows and screen edge */ static int swallowfloating    = 0;        /* 1 means swallow floating windows by default */
...
static Key keys[] = {
	...
	{ MODKEY,			        XK_minus,	        spawn,  		 SHCMD("pamixer --allow-boost -d 2") },
	{ MODKEY|ShiftMask,		XK_minus,	        spawn,		   SHCMD("pamixer --allow-boost -d 5") },
	{ MODKEY,			        XK_equal,	        spawn,		   SHCMD("pamixer --allow-boost -i 2") },
	...
	{ MODKEY|Mod1Mask|ShiftMask|ControlMask, XK_n,   spawn,		      SHCMD("$HOME/.scripts/notification/send/run_notify_send_test.sh --dynamic") },
	...
	{ MODKEY|ControlMask, XK_F9,		       spawn,		      SHCMD("gromit-mpx") },
