...
/*   if (c->isfullscreen && */
/*       !c->fakefullscreen) /1* no support resizing fullscreen windows by mouse *1/ */
/*     return; */
/* #else */
...
/*   /1* do not allow mfact to be modified under certain conditions *1/ */
...
/*   if (!(c = selmon->sel) || !c->mon->lt[c->mon->sellt]->arrange) /1* no support for placemouse when floating layout is used *1/ */
/*     return; */
/*   if (c->isfullscreen) /1* no support placing fullscreen windows by mouse *1/ */
/*     return; */
/*   restack(selmon); */
/*   prevr = c; */
/*   if (XGrabPointer(dpy, root, False, MOUSEMASK, GrabModeAsync, GrabModeAsync, */
